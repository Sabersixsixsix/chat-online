package com.saber.chatonline.ws;

import com.alibaba.fastjson.JSON;
import com.saber.chatonline.config.GetHttpSessionConfigurator;
import com.saber.chatonline.pojo.Message;
import com.saber.chatonline.utils.MessageUtils;
...
public class ChatEndPoint {
    ...
    public void onOpen(Session session, EndpointConfig config) {
        ...
        log.info("用户：{} 已上线，httpsession为{}，session为{}", user, httpSession, session);
        if (user != null) {
    ...
    public void onMessage(String message) {
        try {
            ...
            String currentUser = (String) this.httpSession.getAttribute("user");
    ...
    public void onClose(Session session) throws IOException {
        ...
        String user = (String) this.httpSession.getAttribute("user");
        log.info("用户：{} 已下线，httpsession为{}，session为{}", user, httpSession, session);
        if (user != null) {
